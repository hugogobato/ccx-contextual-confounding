# ---- WP 3.3 separation-study driver (v3: statistics only; CVs applied
# locally). Statistics follow the v3 pipeline (linear detrend, trim 0.05,
# per-context standardization); HSIC uses the abs residual convention.
...
for gi, g in enumerate(CONFIG["groups"]):
    ...
    for j, seed in enumerate(todo):
        ...
        obs = {"k1": k1_v3_stat(x, y, trim_q=0.05),
               "k2": k2_v3_stat(x, y, trim_q=0.05),
